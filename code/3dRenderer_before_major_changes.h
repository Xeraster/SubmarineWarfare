...
public:
	...
	bool OnUserCreate()// override
	{
		...
		//meshCube.LoadFromObjectFile("pooptest.obj",true);
		//meshCube.LoadFromObjectFile("cylinder.obj",true);
		//meshCube.LoadFromObjectFile("cylinder_trisonly.obj",true);
		//meshCube.LoadFromObjectFile("cylinder_quads.obj",true);
		meshCube.LoadFromObjectFile("bouy.obj",true);
		cout << "loaded meshCube object";
		//meshCube.print();
	...
	void TexturedTriangle(	int x1, int y1, float u1, float v1, float w1,
		...
		SDL_Texture *tex, color luminance)
	{
		if (y2 < y1)
		{
			swap(y1, y2);
